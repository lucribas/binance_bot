...
def pattern( candle, position )
	...
	## Check of patters with two candlesticks */
			...
			if ( c2[:trend]==:DOWN and c2[:bull] and !c1[:bull] and # check direction of trend and direction of candlestick
			...
			# Belt Hold, the Bear
			if ( c2[:trend]==:UPPER and !c2[:bull] and c1[:bull] and # check direction of trend and direction of candlestick
				c2[:type]==:CAND_MARIBOZU_LONG and # the "long Maribozu" check
			...
			#------
			# Engulfing, the Bull
			if ( c1[:trend]==:DOWN and !c1[:bull] and c2[:trend]==:DOWN and c2[:bull] and # check direction of trend and direction of candlestick
			...
			# Engulfing, the Bear
			if ( c1[:trend]==:UPPER and c1[:bull] and c2[:trend]==:UPPER and !c2[:bull] and # check direction and direction of candlestick
				c1[:bodysize]<c2[:bodysize]) then # body of the third candlestick is bigger than that of the second one
			...
			if ( c1[:trend]==:DOWN and !c1[:bull] and # check direction of trend and direction of candlestick
			...
			if ( c1[:trend]==:UPPER and c1[:bull] and # check direction of trend and direction of candlestick
			...
			#------
			# Harami, the Bull
			if ( c1[:trend]==:DOWN  and  !c1[:bull]  and  c2[:bull] and# check direction of trend and direction of candlestick
			...
			# Harami, the Bear
			if ( c1[:trend]==:UPPER and c1[:bull] and !c2[:bull] and # check direction of trend and direction of candlestick
				(c1[:type]==:CAND_LONG or c1[:type]==:CAND_MARIBOZU_LONG) and # check of "long" first candlestick
	...
	# 		if ( c1[:trend]==:DOWN and !c1[:bull] and c3[:trend]==:DOWN and c3[:bull] and # check direction of trend and direction of candlestick
	...
	# 		if ( c1[:trend]==:UPPER and c1[:bull] and c3[:trend]==:UPPER and !c3[:bull] and # check direction of trend and direction of candlestick
	# 			(c1[:type]==:CAND_LONG or c1[:type]==:CAND_MARIBOZU_LONG) and (c3[:type]==:CAND_LONG or c3[:type]==:CAND_MARIBOZU_LONG) and # check of "long" candlestick
	# 			c2[:type]==:CAND_DOJI and # check if the second candlestick is Doji
	...
	# 		if ( c1[:trend]==:UPPER and c1[:bull] and c2[:trend]==:UPPER and !c2[:bull] and c3[:trend]==:UPPER and !c3[:bull] and # check direction of trend and direction of candlestick
	# 			(c1[:type]==:CAND_LONG or c1[:type]==:CAND_MARIBOZU_LONG)  and  # check of "long" candlestick
	...
	# 		if ( c1[:trend]==:DOWN and !c1[:bull] and !c2[:bull] and !c3[:bull] and # check direction of trend and direction of candlestick
	...
	# 		if ( c1[:trend]==:UPPER and c1[:bull] and c2[:bull] and c3[:bull] and # check direction of trend and direction of candlestick
	# 			(c1[:type]==:CAND_LONG or c1[:type]==:CAND_MARIBOZU_LONG) and (c2[:type]==:CAND_LONG or c2[:type]==:CAND_MARIBOZU_LONG) and # check of "long" candlestick
	...
	# 		if ( c1[:trend]==:DOWN and !c1[:bull] and c2[:trend]==:DOWN and c2[:bull] and c3[:bull] and # check direction of trend and direction of candlestick
	...
	# 		if ( c1[:trend]==:UPPER and c1[:bull] and c2[:trend]==:UPPER and !c2[:bull] and !c3[:bull] and # check direction of trend and direction of candlestick
	# 			c2[:bodysize]>c1[:bodysize] and # body of the second candlestick is bigger than that of the first one
	...
	# 		if ( c1[:trend]==:DOWN and !c1[:bull] and !c2[:bull] and !c3[:bull] and !c4[:bull] and # check direction of trend and direction of candlestick
	...
	# 		if ( c1[:trend]==:UPPER and c1[:bull] and c2[:bull] and c3[:bull] and !c4[:bull] and # check direction of trend and direction of candlestick
	# 			(c1[:type]==:CAND_LONG or c1[:type]==:CAND_MARIBOZU_LONG) and (c2[:type]==:CAND_LONG or c2[:type]==:CAND_MARIBOZU_LONG) and # check of "long" candlestick or "maribozu"
	# 			(c3[:type]==:CAND_LONG or c3[:type]==:CAND_MARIBOZU_LONG) and # check "long" candlestick and "maribozu"
	...
	# 		#------
	# 		# Breakaway, the Bull
	# 		if ( c1[:trend]==:DOWN and !c1[:bull] and !c2[:bull] and !c4[:bull] and c5[:bull] and # check direction of trend and direction of candlestick
	...
	# 		# Breakaway, the Bear
	# 		if ( c1[:trend]==:UPPER and c1[:bull] and c2[:bull] and c4[:bull] and !c5[:bull] and # check direction of trend and direction of candlestick
	# 			(c1[:type]==:CAND_LONGor c1[:type]==:CAND_MARIBOZU_LONG) and  # check of "long" first candlestick
	# 			c2[:type]==:CAND_SHORT and c2[:open]<c1[:close] and # the second "candlestick" is "short" and is cut off the first one
	# 			c3[:type]==:CAND_SHORT and c4[:type]==:CAND_SHORT and # the third and fourth candlesticks are "short"
